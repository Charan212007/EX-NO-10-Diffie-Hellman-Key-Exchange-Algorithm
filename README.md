...
int main() {
    ...
    printf("Enter the private key for SANJAY (a): ");
    scanf("%lld", &a);
    x = mod_exp(G, a, P); 


    printf("Enter the private key for ASHWIN (b): ");
    scanf("%lld", &b);
    y = mod_exp(G, b, P);
...
## Output:
![image](https://github.com/user-attachments/assets/12f3a8be-735c-49e9-a39c-1d84b5a8f64b)
